	...
	if (isset($_POST['signin']))
	{
		...
		$conn = mysqli_connect("localhost", "root", "", "connectband") 
				...
				if($conn==true)
				{
					...
					//echo $q;
					$result = $conn->query("SELECT * FROM `user_master` where user_name ='".$username."' and password ='".$password."'");
                                ...
                                <div class="content_box_inner">
                                    <div>
                                        ...
                                        <!--<div class="mt75 row justify-content-center"> -->
											<form class="mt75 row justify-content-center" method="post" action="register.php">
												...
												<div class="col-lg-6 col-12">
													<input type="password" name="cnfpwd" placeholder="Confirm Password" class="form-control" required>
												</div>
												<div class="col-lg-6 col-12">
													<input type="text" name="mobile" placeholder="Contact No." class="form-control" required>
												</div>
											<div class="col-12">

  												<input id="btnregister" type="submit"  name="register" class="btn btn-primary" value="Register">
